...
cd '/Users/sorush/My Drive/Documents/Educational/TAMU/Research/Trial/Data/11-5-21-11-15-21/CGM'
for counter= 1:1
    participant="p"+string(counter)+"_fl.txt"
    
    opts = detectImportOptions(participant)
    opts = setvartype(opts,{'CGM'},'double');
    table = readtable(participant,opts);
    ...
    writetable(table,"smoothed-"+participant)
